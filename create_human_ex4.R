...
hd <-dplyr::rename(hd, HDI =Human.Development.Index..HDI., LifeExpect = Life.Expectancy.at.Birth, ExpEduYr= Expected.Years.of.Education, MeanEduYr= Mean.Years.of.Education ,  GNI_Cap=Gross.National.Income..GNI..per.Capita, RankDiff_GNI_HDI=GNI.per.Capita.Rank.Minus.HDI.Rank )
